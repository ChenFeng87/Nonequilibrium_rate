...
tmax = 4e7; h = 0.1; V = 35; r = 4;  % V = 35 is the volume
...
MFPT_NEB = MFPTmatrixWithHessian(minima_array(:, 3),minimaHessian_kde,saddle_e,barrierHessian_kde,[barrierMinima(:,1) [1:size(barrierMinima(:,1),1)]' barrierMinima(:,2)],1,1/D);
