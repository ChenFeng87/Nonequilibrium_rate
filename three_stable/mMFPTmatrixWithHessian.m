function [mfpts,Saddleun] = mMFPTmatrixWithHessian(state_energies, state_hessians, saddle_energies, saddle_hessians, transitions, temperature, friction)
%MFPTMATRIX Returns :
...
for i = 1:N_saddles
    ...
    if length(idxs) ~= 1
        fprintf('Saddle with <>1 unstable eigenvalue');
        Saddleun=1;
        continue;
    end
